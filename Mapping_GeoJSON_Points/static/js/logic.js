...
// Grabbing our GeoJSON data. ON EACH FEATURE
L.geoJson(sanFranAirport, {
  onEachFeature: function(feature, layer) {
    console.log(layer);
    layer.bindPopup("<h2>" + feature.properties.faa + ", " + feature.properties.name + ", " + feature.properties.country + "</h2>")
  }
}).addTo(map);
...
// We create the tile layer that will be the background of our map. NIGHT VIEWS
